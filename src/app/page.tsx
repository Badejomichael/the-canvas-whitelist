      ...
      {/* giant muted CANVAS */}
        <h1
          ...
          style={{
            ...
            fontSize: "clamp(4rem, 18vw, 18rem)", // 🚀 bigger base size for mobile
          }}
        >
          CANVAS
        </h1>
...
"
      ...
      {/* left art cluster */}
      <section className="relative z-20 mx-auto grid min-h-dvh w-full max-w-7xl grid-cols-1 items-end gap-[-10] md:gap-12  px-6 pb-8 md:grid-cols-2 md:items-center md:px-10 md:pt-40">
        {/* characters + grid */}
...
{/* right icon */}
  ...
  />
    ...
    {/* eligibility checker - minimal like UI */}
<div className="relative z-30 flex w-full justify-center md:justify-end mt-0">
...
<div
  ...
  style={{
    height: "22vh", // shorter so it doesn’t touch the card
