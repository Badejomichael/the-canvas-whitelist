...
export default function Page() {
  ...
  return (
    <main className="relative min-h-dvh overflow-hidden">
      ...
      {/* pink script Canvas stroke */}
        <div
          aria-hidden
          className="pointer-events-none select-none absolute inset-x-0 z-0 mx-auto text-center leading-none top-[8vh] md:top-[20vh]"
          style={{
  ...
  <Image
    ...
    width={120}
    height={120}
    className="absolute -right-0 md:left-123 bottom-42 md:bottom-68 w-14 md:w-32 drop-shadow-[0_8px_20px_rgba(0,0,0,.5)]"
  />
</div>
        ...
        <div className="flex w-full justify-center md:justify-end md:self-center md:translate-y-20">
          <div className="w-full max-w-md rounded-xl border border-white/10 bg-black/30 p-6 backdrop-blur-md">
            <p className="mb-4 text-center text-lg font-bold uppercase tracking-widest"
              style={{
                fontFamily: "Bison",
                }}
              >
